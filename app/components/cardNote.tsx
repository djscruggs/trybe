...
export default function CardNote ({ note, isReplyTo = false, showReplies = false }: { note: Note, isReplyTo: boolean, showReplies: boolean }): JSX.Element {
            ...
            {currentUser &&
              <div className="mt-4 text-xs text-gray-500">
                ...
                {currentUser?.id === note.userId &&
                  <span className='underline cursor-pointer' onClick={handleReply}>add reply</span>
                }
              </div>
            }
          </Card>
